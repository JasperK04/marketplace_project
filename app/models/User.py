...
from app.models.mixin import PaginatedAPIMixin, UserMixin
...
class User(PaginatedAPIMixin, UserMixin, db.Model):
    ...
    def check_token(token: str):
        ...
        if (
            ...
            or user.token_expiration.replace(tzinfo=timezone.utc)
    ...
    def valid_password(
        password: str,
    ):  # See https://pages.nist.gov/800-63-4/sp800-63b.html#passwordver
