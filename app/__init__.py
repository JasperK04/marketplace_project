...
app.config['UPLOAD_FOLDER'] = path.abspath('app/static/assets/images/listings/')
app.config['RESIZED_FOLDER'] = path.abspath('app/static/assets/images/listings_resized/')
